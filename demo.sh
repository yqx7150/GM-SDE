...
# for multiple GPUs
# python -m torch.distributed.launch --nproc_per_node=2 --master_port=6512 train.py -opt=options/train/ir-sde_muti-mask.yml --launcher pytorch
...
### testing ###
# python test.py -opt=options/test/ir-sde_muti-mask.yml
